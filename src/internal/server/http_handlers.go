...
func buildRouteHandlers(svc appServices, spaIndex echo.HandlerFunc) httptransport.Handlers {
	...
	return httptransport.Handlers{
		...
		APIRetryJob:        httptransport.JobControlHandlers{CurrentUserOrUnauthorized: transportCurrentUserOrUnauthorized, GetJob: svc.runtime.GetJob, HasJobBlob: store.HasJobBlob, PrepareForPDFRetry: svc.lifecycle.PrepareForPDFRetry, ResetForTranscribe: svc.lifecycle.ResetForTranscribe, EnqueuePDFExtract: svc.runtime.EnqueuePDFExtract, EnqueueTranscribe: svc.runtime.EnqueueTranscribe, StatusFailed: statusFailed, BlobAudioAAC: store.BlobKindAudioAAC, BlobPDFOriginal: store.BlobKindPDFOriginal}.Retry(),
		APIRetranscribeJob: httptransport.JobControlHandlers{CurrentUserOrUnauthorized: transportCurrentUserOrUnauthorized, GetJob: svc.runtime.GetJob, HasJobBlob: store.HasJobBlob, ResetForPDF: svc.lifecycle.ResetForPDF, ResetForTranscribe: svc.lifecycle.ResetForTranscribe, EnqueuePDFExtract: svc.runtime.EnqueuePDFExtract, EnqueueTranscribe: svc.runtime.EnqueueTranscribe, StatusCompleted: statusCompleted, BlobAudioAAC: store.BlobKindAudioAAC, BlobRefined: store.BlobKindRefined, BlobPDFOriginal: store.BlobKindPDFOriginal}.Retranscribe(),
		APIRefineJob:       httptransport.JobControlHandlers{CurrentUserOrUnauthorized: transportCurrentUserOrUnauthorized, GetJob: svc.runtime.GetJob, SetJobFields: svc.runtime.SetJobFields, HasJobBlob: store.HasJobBlob, EnqueueRefine: svc.runtime.EnqueueRefine, HasGeminiConfigured: svc.geminiRt.HasConfigured, StatusCompleted: statusCompleted, StatusRefiningPending: statusRefiningPending, BlobTranscript: store.BlobKindTranscript, BlobRefined: store.BlobKindRefined}.Refine(),
		APIRerefineJob:     httptransport.JobControlHandlers{CurrentUserOrUnauthorized: transportCurrentUserOrUnauthorized, GetJob: svc.runtime.GetJob, SetJobFields: svc.runtime.SetJobFields, HasJobBlob: store.HasJobBlob, DeleteJobBlob: store.DeleteJobBlob, EnqueueRefine: svc.runtime.EnqueueRefine, HasGeminiConfigured: svc.geminiRt.HasConfigured, StatusCompleted: statusCompleted, StatusRefiningPending: statusRefiningPending, BlobTranscript: store.BlobKindTranscript, BlobRefined: store.BlobKindRefined}.Rerefine(),
